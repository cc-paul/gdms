...
<html>
	...
	<body class="hold-transition skin-green-light fixed sidebar-mini">
				...
				<section class="content col-md-6 col-sm-12">
					<div class="nav-tabs-custom">
						<ul class="nav nav-tabs">
							<li class="active"><a href="#admin" data-toggle="tab" aria-expanded="true" class="cust-label">Colleges List</a></li>
								...
								<div class="row">
									<div class="col-md-6 col-xs-12">
										<div class="form-group">
											<input id="txtSearchCollege" class="form-control input-sm cust-label" type="text" placeholder="Search College,Campus or Units here...">
										</div>
									</div>
									<div class="col-md-3 col-xs-6">
										<div class="form-group">
											<button id="btnAddCollege" type="button" class="btn btn-block btn-default btn-sm cust-textbox">
									...
									<div class="col-md-3 col-xs-6">
										<div class="form-group">
											<button id="btnExportCollege" type="button" class="btn btn-block btn-default btn-sm cust-textbox">
								...
								<div class="row">
									<div class="col-md-12 col-sm-12">
										<div class="table-container">
											<table id="tblCollege" name="tblCollege" class="table table-bordered table-hover cust-label" style="width: 100% !important;">
												<thead>
													<tr>
														<th>College / Unit / Campus</th>
														<th></th>
													</tr>
												</thead>
												<tbody></tbody>
		...
		<!-- Modal Name  -->
		<div class="modal fade" id="mdCollege" name="mdCollege">
			<div class="modal-dialog modal-md">
				<div class="box box-default">
					<div class="box-header with-border">
						<label class="cust-label">College Details</label>
					...
					<div class="box-body">
						<div class="row">
							<div class="col-md-12 col-sm-12">
								<label class="cust-label">College</label>
								<label class="cust-label text-danger">*</label>
								<textarea id="txtCollege" name="txtCollege" rows="2" class="form-control cust-label cust-textbox" placeholder="Enter College,Campus or Unit Name"></textarea>
							</div>
						</div>
					</div>
					<div class="box-footer">
						<div class="row">
							...
							<div class="col-md-3 col-xs-12">
								<button id="btnSaveCollege" name="btnSaveCollege" type="button" class="btn btn-block btn-default btn-sm cust-textbox">
		...
		<script src="../program_assets/js/web_functions/colleges.js?random=<?php echo uniqid(); ?>"></script>
