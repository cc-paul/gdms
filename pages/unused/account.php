								...
								<div class="row">
									<div class="col-md-8 col-xs-12">
										<div class="form-group">
											<input id="txtSearchAdmin" class="form-control input-sm cust-label" type="text" placeholder="Search account here...">
										</div>
									</div>
									<div class="col-md-2 col-xs-6">
										<div class="form-group">
											<button id="btnAddAdmin" type="button" class="btn btn-block btn-default btn-sm cust-textbox">
									...
									<div class="col-md-2 col-xs-6">
										<div class="form-group">
											<button id="btnExportAdmin" type="button" class="btn btn-block btn-default btn-sm cust-textbox">
					...
					<div class="box-body">
						...
						<div class="row">
							<div class="col-md-4 col-sm-12">
								<div class="form-group">
									<label class="cust-label">User ID</label>
									<label class="cust-label text-danger">*</label>
									<input type="text" class="form-control cust-label cust-textbox" id="txtEmployeeID" name="txtEmployeeID" placeholder="Enter User ID" maxlength="6" onkeyup="numOnly(this)">
								</div>
							</div>
