				...
				<section class="content col-md-6 col-sm-12">
					<div class="nav-tabs-custom">
						<ul class="nav nav-tabs">
							<li class="active"><a href="#admin" data-toggle="tab" aria-expanded="true" class="cust-label">GAD</a></li>
						...
						<div class="tab-content">
							<div class="tab-pane active" id="admin">
								<div class="row">
									...
									<div class="col-md-3 col-xs-6">
										<div class="form-group">
											<button id="btnExportGAD" type="button" class="btn btn-block btn-default btn-sm cust-textbox">
							...
							<div class="tab-pane" id="gender">
								<div class="row">
									<div class="col-md-6 col-xs-12">
										<div class="form-group">
											<input id="txtSearchGender" class="form-control input-sm cust-label" type="text" placeholder="Search Gender here...">
										</div>
									</div>
									<div class="col-md-3 col-xs-6">
										<div class="form-group">
									...
									<div class="col-md-3 col-xs-6">
										<div class="form-group">
											<button id="btnExportGender" type="button" class="btn btn-block btn-default btn-sm cust-textbox">
												<i class="fa fa-file-excel-o"></i>
												&nbsp;
												Export to Excel
											</button>
								...
								<div class="row">
									<div class="col-md-12 col-sm-12">
										<div class="table-container">
											<table id="tblGender" name="tblGender" class="table table-bordered table-hover cust-label" style="width: 100% !important;">
												<thead>
													<tr>
														<th>Year</th>
														<th>Statement</th>
